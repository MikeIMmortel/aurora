    ...
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">
          ...
          <span className="text-gray-500"> · meting {formatDate(latest.date)}</span>
        </p>
      </div>
      ...
      >
        ...
        <p className="text-base text-gray-200 leading-relaxed">{summary.message}</p>
      </div>
      ...
      <div className="rounded-2xl border border-aurora-border bg-aurora-surface p-5 flex flex-col gap-3">
        <h3 className="text-sm font-semibold text-white">Hoe lees je dit?</h3>
        ...
        <p className="text-xs text-gray-500 leading-relaxed">
          <strong className="text-gray-400">BMI is bewust laag gezet</strong> in deze
